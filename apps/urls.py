...
from apps.views import CategoryListView, CustomLoginView, ProductListView, ProductDetailView, \
    ...
    StreamDetailView, StreamStatisticsListView, SendEmailView


# 192.168.20.122:8080/send-email?receiver_email=self_email&msg=
urlpatterns = [
    path('', CategoryListView.as_view(), name='home'),
    path('send-email', SendEmailView.as_view(), name='send_mail'),
